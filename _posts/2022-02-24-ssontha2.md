...
Fig 1: Spatial localization of normalized CD8 abundance in CODEX dataset. The 8 Proteins with the least varying abudance (Var< 1.141120e-04, this is arbitrary and I felt that other proteins might be sufficient to identify the tissue) were removed from the dataset for further analysis. Normalization was performed by dividing fluorescence intensity values by cell 2D area and total protein found in the cell. CD8 is a protein found in T cells. Appears to be little CD8+ cells outside of the relatively acellular region of the section. 
