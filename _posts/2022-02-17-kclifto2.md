---
layout: post
title:  "Mature Oligodendrocytes in MERFISH Data Predicted by Olig1 presence and Pdgfra absence"
author: Kalen C
jhed: kclifto2
categories: [ HW4 ]
image: homework/hw4/kalenclifton.png
featured: false
---
...
p1 <- ggplot(data=df1, mapping = aes(x=x, y=y)) +
  ...
  labs(title="OPCs and mature oligodendrocytes", x = "tSNE1" , y = "tSNE2")
...
p2 <- ggplot(data=df2, mapping = aes(x=x, y=y)) +
  ...
  labs(title="OPCs", x = "tSNE1" , y = "tSNE2")
#p2
...
p3 <- ggplot(data=df3, mapping = aes(x=x, y=y)) +
  ...
  labs(title="Olig1 > 4 & Pdgfra = 0", x = "tSNE1" , y = "tSNE2")
#p3
...
p4 <- ggplot(data = df4, mapping = aes(x = x, y = y)) +
  ...
  scale_color_manual("", values = c("black","green")) +
  theme_classic(base_size=22) +
  labs(title="Mature oligodendrocytes", x = "x position" , y = "y position")
...
pk <- ggplot(data = dfk,
  ...
  labs(title="Kmeans on gene expression", x = "tSNE1" , y = "tSNE2")
#pk
...
pmo <- ggplot(data = dfmo,
  ...
  geom_scattermore(mapping = aes(col = col), 
                   pointsize=1) + theme_classic(base_size=22) +
  scale_color_manual("", values = c("black","green")) +
  labs(title="Cluster 2", x = "tSNE1" , y = "tSNE2")
#pmo
